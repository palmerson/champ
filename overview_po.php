...
<!--      <a target="_blank" class="nonblock nontext clip_frame grpelem" id="u3796" href="report_po.php"><img class="block" id="u3796_img" src="images/searchreport_but.png" alt="" width="180" height="55"/></a> -->
    </div>
...
<!--     <th class="tg-031e">ลำดับ</th> -->
  ...
  while($row = mysql_fetch_array($query)) {
    ...
    <tr>
      ...
      <td class="tg-vn4c"><a href="edit_po.php?id=<?php echo $row['po_id'];?>" alt="แก้ไข" title="แก้ไข"><img src="images/edit.png" alt="แก้" title="แก้ไข" width="16" height="16"></a>&nbsp;&nbsp;
      <a target="_blank" href="print.php?type=po&id=<?php echo $row['po_id'];?>" alt="พิมพ์ใบเสร็จ" title="พิมพ์ใบเสร็จ"><img src="images/print.png" width="17" height="16"></a></td>
    </tr>
    <?php }else{ ?>
      <tr>
        ...
        <td class="tg-031e"><a href="edit_po.php?id=<?php echo $row['po_id'];?>" alt="แก้ไข"><img src="images/edit.png" alt="แก้" title="แก้ไข" width="16" height="16"></a>&nbsp;&nbsp;
        <a target="_blank" href="print.php?type=po&id=<?php echo $row['po_id'];?>" alt="พิมพ์ใบเสร็จ" title="พิมพ์ใบเสร็จ"><img src="images/print.png" width="17" height="16"></a></td>
      </tr>
    <?php }
        $counter++;
