...
<!--     <th class="tg-031e">ลำดับ</th> -->
  ...
  while($row = mysql_fetch_array($query)) {
    ...
    <tr>
      ...
      <td class="tg-vn4c"><a href="print_po.html"><img src="images/print.png" alt="พิมพ์" width="17" height="16"></a></td>
    </tr>
    <?php }else{ ?>
      <tr>
        <td class="tg-031e"></td>
        ...
        <td class="tg-031e"><a href="edit_po.php?<?php echo $row['po_id'];?>"><img src="images/edit.png" alt="แก้" width="16" height="16"></a></td>
        <td class="tg-031e"><a href="print_po.html"><img src="images/print.png" alt="พิมพ์" width="17" height="16"></a></td>
      </tr>
    <?php }
        $counter++;
  }
