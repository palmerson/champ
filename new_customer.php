 ...
 <?php include 'inc/conf.php'; ?>
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    ...
    <form enctype="multipart/form-data" action="action_add_customer.php" method="POST" id="add_customer">
    ...
    <div class="clearfix colelem" id="pu840-3"><!-- group -->
     <input class="clearfix grpelem" id="u840-3" name="customer_id"><!-- content -->
    ...
    <div class="clearfix colelem" id="pu837-3"><!-- group -->
     <input class="clearfix grpelem" id="u837-3" name="company"><!-- content -->
     <input class="clearfix grpelem" id="u972-3" name="contact"><!-- content -->
    </div>
    ...
    <div class="clearfix colelem" id="pu864-3"><!-- group -->
     ...
     <input class="clearfix grpelem" id="u966-3" name="phone"><!-- content -->
     <input class="clearfix grpelem" id="u984-3" name="fax"><!-- content -->
     <input class="clearfix grpelem" id="u888-3" name="credit"><!-- content -->
    </div>
    ...
    <div class="clearfix colelem" id="pu870-3"><!-- group -->
     <input class="clearfix grpelem" id="u870-3" name="town"><!-- content -->
     <input class="clearfix grpelem" id="u897-3" name="city"><!-- content -->
     <input class="clearfix grpelem" id="u957-3" name="zip"><!-- content -->
    </div>
    <div class="clearfix colelem" id="pu5153"><!-- group -->
     ...
     <button type="submit" form="add_customer" value="Submit" class="nonblock nontext clip_frame grpelem" id="u1625" ><!-- svg --><img class="svg" id="u1626" src="images/pasted-svg-200x60.svg" width="183" height="55" alt="" data-mu-svgfallback="images/pasted%20svg%20200x60_poster_.png"/></button>
    </div>
    </form>
