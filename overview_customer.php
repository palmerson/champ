 ...
 <?php 
  ...
  ?>
    <tr>
     ...
     <td class="tg-vn4c"><a href="view_customer.php?id=<?php echo $row['customer_id'];?>"><img src="images/view.png" alt="ดู" width="17" height="16"></a></td>
      <td class="tg-vn4c"><a href="edit_customer.php?id=<?php echo $row['customer_id'];?>"><img src="images/edit.png" alt="แก้" width="16" height="16"></a></td>
    </tr>
  <?php
    } else{
  ?>
    <tr>
     ...
     <td class="tg-031e"><a href="view_customer.php?id=<?php echo $row['customer_id'];?>"><img src="images/view.png" alt="ดู" width="17" height="16"></a></td>
      <td class="tg-031e"><a href="edit_customer.php?id=<?php echo $row['customer_id'];?>"><img src="images/edit.png" alt="แก้" width="16" height="16"></a></td>
    </tr>
  <?php  }
   $counter++;
  }
