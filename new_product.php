     ...
     <div class="clearfix grpelem" id="ppu611-4"><!-- column -->
      ...
      <!-- custom html -->
       ...
       <div class="grpelem" id="u1375"><!-- custom html -->
        <input class="product_name_box" type="text" name="name"> 
<style> 
 .product_name_box { 
    outline:0; 
    height:40px; 
    width: 308px; 
      ...
      <div class="clearfix colelem" id="pu641-3"><!-- group -->
       <div class="clearfix grpelem" id="u641-3"><!-- content -->
        <input class="textbox2" type="text" name="price">
        <style> 
         .textbox2 { 
            outline:0; 
            height:40px; 
...
<style> 
 .textbox { 
    ...
    <div class="clearfix colelem" id="pu5058"><!-- group -->
     ...
     <button type="submit" form="add_product" value="Submit" class="nonblock nontext clip_frame grpelem" id="u1616"><!-- svg --><img class="svg" id="u1617" src="images/pasted-svg-200x60.svg" width="183" height="55" alt="" data-mu-svgfallback="images/pasted%20svg%20200x60_poster_.png"/></button>
    </div>
    </form>
