    ...
    <div class="clearfix colelem" id="pppu611-4"><!-- group -->
     <div class="clearfix grpelem" id="ppu611-4"><!-- column -->
      ...
      <div class="clearfix colelem" id="pu1364"><!-- group -->
       <div class="grpelem" id="u1364" style="outline:0;height:40px;width: 80px; background-color: #FFF;"><!-- custom html -->
       <?php echo $row[0];?>
       </div>
       <div class="grpelem" id="u1375" style="outline:0;height:40px;width: 308px; background-color: #FFF;">
         <?php echo $row[1];?>
       </div>
      </div>
      ...
      <div class="clearfix colelem" id="pu641-3"><!-- group -->
       <div class="clearfix grpelem" id="u641-3"><!-- content -->
        <p id="u641"><?php echo $row[3];?></p>
       </div>
       <div class="grpelem" id="u1385" style="outline:0;height:40px;width: 80px; background-color: #FFF;"> 
        <?php echo $row[2];?>
       </div>
