...
-->
 ...
 <body class="museBGSize">
  <?php
    ...
    $sql = "SELECT * FROM $Customers a LEFT JOIN $CustomersType b ON a.customer_type=b.customer_type_id WHERE customer_id = '$id'";
  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    ...
    <div class="clearfix colelem" id="pu840-3"><!-- group -->
     ...
     <div class="clearfix grpelem" id="u963-3"><!-- content -->
      <p id="u963"><?php echo $row[12];?></p>
     </div>
    </div>
    ...
    <div class="clearfix colelem" id="pu837-3"><!-- group -->
     <div class="clearfix grpelem" id="u837-3"><!-- content -->
      <p id="u837"><?php echo $row[2];?></p>
     </div>
     <div class="clearfix grpelem" id="u972-3"><!-- content -->
      <p id="u972"><?php echo $row[9];?></p>
     </div>
    </div>
    ...
    <div class="clearfix colelem" id="pu864-3"><!-- group -->
     <div class="clearfix grpelem" id="u864-3"><!-- content -->
      <p id="u864"><?php echo $row[3];?></p>
     </div>
     <div class="clearfix grpelem" id="u966-3"><!-- content -->
      <p id="u966"><?php echo $row[7];?></p>
     </div>
     <div class="clearfix grpelem" id="u984-3"><!-- content -->
      <p id="u984"><?php echo $row[8];?></p>
     </div>
     <div class="clearfix grpelem" id="u888-3"><!-- content -->
      <p id="u888"><?php echo $row[10];?></p>
     </div>
    </div>
    ...
    <div class="clearfix colelem" id="pu870-3"><!-- group -->
     <div class="clearfix grpelem" id="u870-3"><!-- content -->
      <p id="u870"><?php echo $row[4];?></p>
     </div>
     <div class="clearfix grpelem" id="u897-3"><!-- content -->
      <p id="u897"><?php echo $row[5];?></p>
     </div>
     <div class="clearfix grpelem" id="u957-3"><!-- content -->
      <p id="u957"><?php echo $row[6];?></p>
     </div>
    </div>
